// Original source https://github.com/ALLTERCO/shelly-script-examples/blob/main/load-shedding.js
  ...
  */
  ...
  function check_power(msg) {
    ...
    if (def(msg.delta.a_act_power)) {
        for (k in Pro3EM_channels) channel_power[Pro3EM_channels[k]] = msg.delta[Pro3EM_channels[k] + "_act_power"];
    }
